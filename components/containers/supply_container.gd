...
@export var _editor_supplies: Array[Supply] = []  ## this is a wrapper for _supplies, due to godot's issue with arrays always sharing resources.
#endregion


#region VARS
var _regen_timer: Timer = Timer.new()
var _supplies: Array[Supply]  ## all supplies. copied from _editor_supplies on _ready.
#endregion
