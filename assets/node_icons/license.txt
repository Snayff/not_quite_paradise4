...
This 16x16 icon pack contains 400 colorful, application-oriented icons.
These were created specifically for RPG in a Box (https://www.rpginabox.com) using Adigun Polack's AAP64 palette.
(Check out the engine if you're interested in creating your own grid-based, voxel-style games!)
